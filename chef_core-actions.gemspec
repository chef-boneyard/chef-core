...
Gem::Specification.new do |spec|
  ...
  spec.summary       = "Common actions for Chef ruby components"
  spec.description   = "Common actions for Chef ruby components"
  spec.homepage      = "https://github.com/chef/chef_core-actions"
