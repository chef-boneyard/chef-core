...
RSpec.describe ChefCore::Actions::Action::GenerateLocalPolicy do
  subject { ChefCore::Actions::Action::GenerateLocalPolicy.new(cookbook: cookbook) }
  let(:cookbook) do
    double("TempCookbook",
  ...
  describe "#perform_action" do
    ...
    context "when PolicyfileServices raises an error" do
      it "reraises as PolicyfileInstallError" do
        ...
        expect { subject.perform_action }.to raise_error(ChefCore::Actions::Action::PolicyfileInstallError)
      end
    end
